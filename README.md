...
The f-subsonic solutions are more likely the commonly used in solar wind modeling and state of art. They embed relatively slowly accelerating wind, and a critical radius location between 3 and 8 $r_\odot$ for coronal temperature of the order of 0.5 - 3 MK. The influence of the super expansion modeled by the expansion factor is to create a deceleration region in the super expansion region. 
The f-supersonic solutions are known but more less used in the space weather community. They induces quickly acceleration solar wind solution, with a critical radius very close to the Sun inside the super expansion region, comprised between 1 and $\sim$ 3 $r_\odot$, for coronal temperature of the order of 0.5 - 3 MK.  They also induce a deceleration region but approximately from the end of the super expansion region until $\sim$ 8 $r_\odot$. The switch between the two solutions depends on the determination of the critical radius that respects the trans-sonic solutions requirements.  
